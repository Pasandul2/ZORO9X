...
# Configuration
CONFIG_FILE = 'resturent_config.json'
...
class testApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("test - Premium Edition")
        ...
        db_name = self.config.get('database_name', 'resturent_premium_database')
