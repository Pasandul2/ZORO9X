...
class testApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("test - Basic Edition")
        ...
        db_name = self.config.get('database_name', 'resturent_basic_database')
    ...
    def show_analy(self):
        ...
        # Add your analy functionality here
        tk.Label(
            view_frame,
            text="analy feature coming soon!",
            font=('Segoe UI', 12),
            bg='#f5f7fa',
            fg='#64748b'
        ).pack(pady=50)
