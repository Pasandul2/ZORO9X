...
class mfkvfvfgApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("mfkvfvfg - Premium Edition")
        ...
        db_name = self.config.get('database_name', 'gfbgb_premium_database')
