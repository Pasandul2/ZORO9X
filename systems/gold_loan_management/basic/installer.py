...
By proceeding, you agree to these terms."""
    ...
    def installing_step(self):
        ...
        self.database_name = (self._pick_subscription_value(subscription, 'database_name', 'db_name') or self.database_name_var.get().strip() or 'gold_loan_database').strip()
