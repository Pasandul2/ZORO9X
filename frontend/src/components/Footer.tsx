          ...
          <nav className="flex flex-wrap justify-center space-x-6 mb-4 md:mb-0">
            ...
            {isLoggedIn ? (
              <>
                <Link
                  to="/dashboard"
                  className="text-sm text-white md:text-gray-600 dark:md:text-gray-400 hover:text-indigo-400 transition duration-300 flex items-center gap-1"
                >
                ...
                <button
                  ...
                  className="text-sm text-white md:text-gray-600 dark:md:text-gray-400 hover:text-red-400 transition duration-300 flex items-center gap-1"
                >
